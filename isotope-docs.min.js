(function (t) {
    ...
    var s = {hasClass: o, addClass: n, removeClass: r, toggleClass: i, has: o, add: n, remove: r, toggle: i};
    ...
    var n = t.document, r = [];
    e.isReady = !1, "function" == typeof define && define.amd ? (e.isReady = "function" == typeof requirejs, define(["eventie/eventie"], o)) : t.docReady = o(t.eventie)
}(this),
    ...
    function o(t) {
        var e = [];
        if (i(t))e = t; else if ("number" == typeof t.length)for (var o = 0, n = t.length; n > o; o++)e.push(t[o]); else e.push(t);
        return e
    }
    ...
    function n(t, i) {
        function n(t, i, s) {
            ...
            "string" == typeof t && (t = document.querySelectorAll(t)), this.elements = o(t), this.options = e({}, this.options), "function" == typeof i ? s = i : e(this.options, i), s && this.on("always", s), this.getImages(), r && (this.jqDeferred = new r.Deferred);
            var a = this;
            setTimeout(function () {
                a.check()
            })
        ...
        n.prototype = new t, n.prototype.options = {}, n.prototype.getImages = function () {
            ...
            for (var t = 0, e = this.elements.length; e > t; t++) {
                ...
                for (var o = i.querySelectorAll("img"), n = 0, r = o.length; r > n; n++) {
                    var s = o[n];
                    this.addImage(s)
                }
            }
            ...
            function t(t, n) {
                return e.options.debug && a && s.log("confirm", t, n), e.progress(t), i++, i === o && e.complete(), !0
            }
    ...
    var r = t.jQuery, s = t.console, a = s !== void 0, u = Object.prototype.toString;
    ...
    function o(t) {
        function o(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var p = r.isBorderBox = !(!h || !o[h] || "border-box" !== o[h]), f = 0, c = a.length; c > f; f++) {
                    var d = a[f], l = o[d];
                    l = n(t, l);
                    var m = parseFloat(l);
                    r[d] = isNaN(m) ? 0 : m
                }
                var y = r.paddingLeft + r.paddingRight, g = r.paddingTop + r.paddingBottom, v = r.marginLeft + r.marginRight, _ = r.marginTop + r.marginBottom, I = r.borderLeftWidth + r.borderRightWidth, z = r.borderTopWidth + r.borderBottomWidth, w = p && u, L = e(o.width);
                L !== !1 && (r.width = L + (w ? 0 : y + I));
                var b = e(o.height);
                return b !== !1 && (r.height = b + (w ? 0 : g + z)), r.innerWidth = r.width - (y + I), r.innerHeight = r.height - (g + z), r.outerWidth = r.width + v, r.outerHeight = r.height + _, r
            }
        }
    ...
    var n = document.defaultView, r = n && n.getComputedStyle, s = r ? function (t) {
        return n.getComputedStyle(t, null)
    } : function (t) {
        return t.currentStyle
    }, a = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"];
    "function" == typeof define && define.amd ? define(["get-style-property/get-style-property"], o) : "object" == typeof exports ? module.exports = o(require("get-style-property")) : t.getSize = o(t.getStyleProperty)
}(window),
    ...
    function n(t, n, r) {
        ...
        var u = r("transition"), h = r("transform"), p = u && h, f = !!r("perspective"), c = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend", transition: "transitionend"}[u], d = ["transform", "transition", "transitionDuration", "transitionProperty"], l = function () {
        ...
        a.prototype._transitionTo = function (t, e) {
            ...
            var a = t - i, u = e - o, h = {}, p = this.layout.options;
            a = p.isOriginLeft ? a : -a, u = p.isOriginTop ? u : -u, h.transform = m(a, u), this.transition({to: h, onTransitionEnd: {transform: this.layoutPosition}, isCleaning: !0})
        ...
        a.prototype.ontransitionend = function (t) {
            if (t.target === this.element) {
                var e = this._transition, o = g[t.propertyName] || t.propertyName;
    ...
    "function" == typeof define && define.amd ? define(["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property"], n) : (t.Outlayer = {}, t.Outlayer.Item = n(t.EventEmitter, t.getSize, t.getStyleProperty))
}(window),
    ...
    function s(i, s, f, d, l, m) {
        function y(t, i) {
            if ("string" == typeof t && (t = a.querySelector(t)), !t || !c(t))return u && u.error("Bad " + this.settings.namespace + " element: " + t), void 0;
        ...
        return y.prototype.settings = {namespace: "outlayer", item: m}, y.prototype.options = {containerStyle: {position: "relative"}, isInitLayout: !0, isOriginLeft: !0, isOriginTop: !0, isResizeBound: !0, transitionDuration: "0.4s", hiddenStyle: {opacity: 0, transform: "scale(0.001)"}, visibleStyle: {opacity: 1, transform: "scale(1)"}}, e(y.prototype, f.prototype), y.prototype.option = function (t) {
            ...
            return e(o.prototype, y.prototype), g(o, "options"), g(o, "settings"), e(o.prototype.options, i), o.prototype.settings.namespace = t, o.data = y.data, o.Item = function () {
                m.apply(this, arguments)
            }, o.Item.prototype = new m, o.prototype.settings.item = o.Item, s(function () {
    ...
    function e(t, e) {
        ...
        return o.prototype._resetLayout = function () {
            ...
            for (var r = this._getColGroup(n), s = Math.min.apply(Math, r), a = i(r, s), u = {x: this.columnWidth * a, y: s}, h = s + t.size.outerHeight, p = this.cols + 1 - r.length, f = 0; p > f; f++)this.colYs[a + f] = h;
            return u
    ...
    function r(t, i, r, u, p) {
        function f(t, e) {
            return function (i, o) {
                for (var n = 0, r = t.length; r > n; n++) {
                    ...
                    if (a > u || u > a) {
                        var h = void 0 !== e[s] ? e[s] : e, p = h ? 1 : -1;
                        return(a > u ? 1 : -1) * p
                    }
                }
                return 0
        ...
        c.Item = c.prototype.settings.item = u, c.LayoutMode = p, c.prototype._create = function () {
            ...
            for (var i = [], o = [], n = [], r = this._getFilterTest(e), s = 0, a = t.length; a > s; s++) {
                ...
                if (!u.isIgnored) {
                    var h = r(u);
                    h && i.push(u), h && u.isHidden ? o.push(u) : h || u.isHidden || n.push(u)
                }
            }
        ...
        var d = function () {
            function t(t) {
                ...
                var o = a(t).split(" "), n = o[0], r = n.match(/^\[(.+)\]$/), s = r && r[1], u = e(s, n), h = i(o[1]);
    ...
    }, u = document.documentElement, h = u.textContent ? function (t) {
    ...
    "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "matches-selector/matches-selector", "./item", "./layout-mode"], r) : t.Isotope = r(t.Outlayer, t.getSize, t.matchesSelector, t.Isotope.Item, t.Isotope.LayoutMode)
}(window),
    ...
    "function" == typeof define && define.amd ? define(["../layout-mode", "masonry/masonry"], i) : i(t.Isotope.LayoutMode, t.Masonry)
}(window),
    ...
    function e(t) {
        ...
        return e.prototype._resetLayout = function () {
            ...
            t.getSize();
            var e = this.itemIndex % this.cols, i = Math.floor(this.itemIndex / this.cols), o = (e + .5) * this.columnWidth - t.size.outerWidth / 2, n = (i + .5) * this.rowHeight - t.size.outerHeight / 2;
            return this.itemIndex++, {x: o, y: n}
        }, e.prototype._getContainerSize = function () {
            return{height: Math.ceil(this.itemIndex / this.cols) * this.rowHeight}
        }, e
    }

    "function" == typeof define && define.amd ? define(["../layout-mode", "get-size/get-size"], e) : e(t.Isotope.LayoutMode, t.getSize)
}(window),
    ...
    function e(t, e) {
        ...
        return o.prototype._resetLayout = function () {
            ...
            for (var o = this._getRowGroup(e), n = Math.min.apply(Math, o), r = i(o, n), s = {x: n, y: this.rowHeight * r}, a = n + t.size.outerWidth, u = this.rows + 1 - o.length, h = 0; u > h; h++)this.rowXs[r + h] = a;
            return s
            ...
            var i = t(e), o = this.isotope._getElementOffset(e), n = this.isotope.options.isOriginTop ? o.top : o.bottom, r = n + i.outerHeight, s = Math.floor(n / this.rowHeight);
            s = Math.max(0, s);
    ...
    "function" == typeof define && define.amd ? define(["get-size/get-size", "../layout-mode"], e) : e(t.getSize, t.Isotope.LayoutMode)
}(window),
    ...
    function e(t) {
        ...
        return e.prototype._resetLayout = function () {
            ...
            t.getSize();
            var e = Math.floor(this.itemIndex / this.rows), i = this.itemIndex % this.rows, o = (e + .5) * this.columnWidth - t.size.outerWidth / 2, n = (i + .5) * this.rowHeight - t.size.outerHeight / 2;
            return this.itemIndex++, {x: o, y: n}
        }, e.prototype._getContainerSize = function () {
    ...
    "use strict";
    function e(t) {
        var e = t.create("horizontal", {verticalAlignment: 0});
        return e.prototype._resetLayout = function () {
            this.x = 0
        }, e.prototype._getItemLayoutPosition = function (t) {
            t.getSize();
            var e = (this.isotope.size.innerHeight - t.size.outerHeight) * this.options.verticalAlignment, i = this.x;
            return this.x += t.size.outerWidth, {x: i, y: e}
        }, e.prototype._getContainerSize = function () {
            return{width: this.x}
        }, e.prototype.resize = function () {
            this.resizeVertical()
    ...
    var n;
    docReady(function () {
        n = document.querySelector("#notification"), e(".js-radio-button-group").radioButtonGroup();
        var t = document.body.getAttribute("data-page");
        t && "function" == typeof o[t] && o[t]()
    }), o.getSomeItemElements = function () {
        for (var t = document.createDocumentFragment(), e = [], i = 0; 3 > i; i++) {
            var o = document.createElement("div"), n = Math.random(), r = n > .85 ? "w4" : n > .7 ? "w2" : "", s = Math.random(), a = s > .85 ? "h4" : s > .7 ? "h2" : "";
            o.className = "item " + r + " " + a, t.appendChild(o), e.push(o)
        }
    };
    var r, s = document.documentElement, a = void 0 !== s.textContent ? "textContent" : "innerText", u = getStyleProperty("transition"), h = u ? 1e3 : 1500;
    o.notify = function (t, e) {
        i(n, t), u && (n.style[u] = "none"), n.style.display = "block", n.style.opacity = "1", e && (r && clearTimeout(r), r = setTimeout(o.hideNotify, h))
    }, o.hideNotify = function () {
        u ? (n.style[u] = "opacity 1.0s", n.style.opacity = "0") : n.style.display = "none"
    }, e.fn.radioButtonGroup = function () {
        return this.each(function (t, i) {
            var o = e(i);
            o.find(":checked").parent().addClass("is-checked"), o.on("click", "input", function () {
                o.find(".is-checked").removeClass("is-checked"), e(this).parent().addClass("is-checked")
            })
        }), this
    }
}(window, jQuery),
    ...
    function (t) {
    "use strict";
    var e = t.ID, i = getStyleProperty("transition"), o = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend", transition: "transitionend"}[i];
    e.appendix = function () {
        console.log("hello world", o), function () {
            var t = $("#animate-item-size .isotope").isotope({masonry: {columnWidth: 60}});
            t.on("click", ".item", function () {
                $(this).toggleClass("is-expanded"), t.isotope("layout")
            })
        }(), function () {
            var t = $("#animate-item-size-responsive .isotope").isotope({itemSelector: ".item", masonry: {columnWidth: ".grid-sizer"}});
            t.on("click", ".item-content", function () {
                var e = this, n = getSize(e);
    ...
    n.events = function () {
        (function () {
            var t = e("#layout-complete-demo .isotope").isotope({masonry: {columnWidth: 50}});
            ...
            var t = e("#remove-complete-demo .isotope").isotope({masonry: {columnWidth: 50}});
    ...
    i.filtering = function () {
        (function () {
            var t = {numberGreaterThan50: function () {
                var t = e(this).find(".number").text();
                return parseInt(t, 10) > 50
            }, ium: function () {
                var t = e(this).find(".name").text();
                return t.match(/ium$/)
            }}, i = e("#filtering-demo .isotope").isotope({itemSelector: ".element-item", layoutMode: "fitRows", isJQueryFiltering: !0, transitionDuration: "0.6s"});
            e("#filtering-demo .button-group").on("click", "input", function () {
                var e = t[this.value] || this.value;
                i.isotope({filter: e})
            })
        })()
    }
    ...
    i.index = function () {
        (function () {
            var t = e("#hero .isotope").isotope({itemSelector: ".element-item", layoutMode: "fitRows", transitionDuration: "0.6s", getSortData: {name: ".name", symbol: ".symbol", number: ".number parseInt", category: "[data-category]", weight: function (t) {
            ...
            e("#hero .sort-by").on("click", "input", function () {
                t.isotope({sortBy: this.value})
            }), e("#hero .filters").on("click", "input", function () {
                var e = i[this.value] || this.value;
                t.isotope({filter: e})
            })
        })()
    }
    ...
    i["layout-modes"] = function () {
        (function () {
            var t = e("#layout-modes-demo .isotope").isotope({itemSelector: ".element-item", layoutMode: "masonry", transitionDuration: "0.6s", masonry: {columnWidth: 110}, cellsByRow: {columnWidth: 220, rowHeight: 220}, masonryHorizontal: {rowHeight: 110}, cellsByColumn: {columnWidth: 220, rowHeight: 220}}), i = !1;
            e("#layout-modes-demo .button-group").on("click", "input", function () {
                var n = !!e(this).attr("data-is-horizontal");
                if (i !== n) {
                    var r = n ? {height: .7 * o.height()} : {width: "auto"};
                    t.css(r), i = n
                }
                t.isotope({layoutMode: this.value})
            })
        })()
    }
}(window, jQuery),
    ...
    "use strict";
    function i() {
        var t = document.createElement("div"), e = Math.random(), i = Math.random(), o = e > .8 ? "w3" : e > .6 ? "w2" : "", n = i > .8 ? "h3" : i > .5 ? "h2" : "";
    ...
    o.methods = function () {
        (function () {
            var t = e("#appended-demo"), o = t.find(".isotope").isotope({masonry: {columnWidth: 50}});
            ...
            var t = e("#destroy-demo"), i = {masonry: {columnWidth: 50}}, o = t.find(".isotope").isotope(i), n = !0;
            t.find("button").on("click", function () {
                n ? o.isotope("destroy") : o.isotope(i), n = !n
            })
        }(), function () {
            var t = e("#insert-demo"), o = t.find(".isotope").isotope({masonry: {columnWidth: 50}, filter: function () {
                var t = e(this).find(".number").text();
                return parseInt(t, 10) % 2
            }, sortBy: "number", getSortData: {number: ".number parseInt"}});
            t.find("button").on("click", function () {
                for (var t = [], n = 0; 3 > n; n++) {
                    var r = i(), s = Math.floor(100 * Math.random());
                    e(r).append('<p class="number">' + s + "</p>"), t.push(r)
                }
                o.append(t).isotope("insert", t)
            })
        }(), function () {
            var t = e("#layout-demo .isotope").isotope({masonry: {columnWidth: 50}});
            t.on("click", ".mini-item", function () {
                e(this).toggleClass("gigante"), t.isotope("layout")
            })
        }(), function () {
            var t = e("#prepended-demo"), o = t.find(".isotope").isotope({masonry: {columnWidth: 50}});
            t.find("button").on("click", function () {
                for (var t = [], e = 0; 3 > e; e++) {
                    var n = i();
                    t.push(n)
            ...
            var t = e("#stamp-demo"), i = t.find(".isotope").isotope({itemSelector: ".mini-item", masonry: {columnWidth: 50}}), o = t.find(".stamp"), n = !1;
            t.find("button").on("click", function () {
                n ? i.isotope("unstamp", o) : i.isotope("stamp", o), i.isotope("layout"), n = !n
            })
        }(), function () {
            var t = e("#remove-demo .isotope").isotope({masonry: {columnWidth: 50}});
            t.on("click", ".mini-item", function () {
                t.isotope("remove", this).isotope("layout")
            })
        }()
    ...
    i.sorting = function () {
        (function () {
            var t = e("#sorting-demo .isotope").isotope({itemSelector: ".element-item", layoutMode: "fitRows", transitionDuration: "0.6s", getSortData: {name: ".name", symbol: ".symbol", number: ".number parseInt", category: "[data-category]", weight: function (t) {
                var i = e(t).find(".weight").text();
                return parseFloat(i.replace(/[\(\)]/g, ""))
            }}});
            e("#sorting-demo .button-group").on("click", "input", function () {
                t.isotope({sortBy: this.value})
            })
        })()
    }
    ...
    i.vertical = function () {
        (function () {
            var t = e("#vertical-feature-demo .tixbody").isotope({
                itemSelector: "DIV",
                layoutMode: "vertical",
            ...
            e("#vertical-feature-demo .button-group").on("click", "input", function () {
                $('.isotope').toggleClass('future');
                console.log("hi"), t.isotope({sortBy: this.value})
            })
        })()
    }
    }(window, jQuery);